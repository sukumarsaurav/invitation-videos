    ...
    <div class="mt-10 pt-8 border-t border-slate-200">
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?= urlencode(SITE_URL . '/blog/' . $post['slug']) ?>&title=<?= urlencode($post['title']) ?>"
                    target="_blank"
                        ...
                        <a href="/blog/<?= Security::escape($related['slug']) ?>" class="block">
                            <div class="aspect-video bg-slate-100 relative overflow-hidden">
                                <?php if ($related['featured_image']): ?>
                                    <img src="<?= Security::escape($related['featured_image']) ?>" alt=""
