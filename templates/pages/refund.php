...
$metaDescription = 'Invitation Videos refund policy - full refunds before work begins, partial refunds during production, and free revisions after delivery.';
?>
...
<div class="container-narrow section-padding">
    ...
    <nav class="flex items-center gap-2 text-sm mb-8">
        ...
        <span class="font-medium text-slate-900">Refund Policy</span>
    </nav>

    <div
        class="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 md:p-12">
        <h1 class="heading-section text-slate-900 mb-2">Refund Policy</h1>
        ...
        <div class="prose prose-slate max-w-none">
            ...
            <p class="text-slate-600 mb-4">You are eligible for a full refund if:</p>
            ...
            <p class="text-slate-600 mb-4">A partial refund may be issued if:</p>
            <ul class="list-disc pl-6 text-slate-600 space-y-2 mb-6">
            ...
            <p class="text-slate-600 mb-4">Refunds are not available if:</p>
            <ul class="list-disc pl-6 text-slate-600 space-y-2 mb-6">
            ...
            <div class="bg-slate-50 rounded-xl p-6 mb-6">
                <ol class="list-decimal pl-6 text-slate-600 space-y-3">
