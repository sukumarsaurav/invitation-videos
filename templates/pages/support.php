...
<div class="max-w-4xl mx-auto px-4 py-8 sm:py-12">
    ...
    <div class="text-center mb-12">
        ...
        <h1 class="text-3xl sm:text-4xl font-bold text-slate-900">How can we help?</h1>
    ...
    <div class="grid sm:grid-cols-3 gap-4 mb-12">
        ...
        <a href="https://wa.me/919876543210" target="_blank"
            class="p-6 bg-white rounded-xl border border-slate-200 hover:shadow-lg hover:border-green-300 transition-all text-center group">
            <div
            ...
            <?php foreach ($faqs as $index => $faq): ?>
                <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
                    ...
                    <div id="faqAnswer<?= $index ?>" class="hidden px-5 pb-5">
                        <p class="text-slate-600"><?= Security::escape($faq['answer']) ?></p>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8">
        ...
        <form action="/support" method="POST" class="space-y-5">
            ...
            <div>
                <label for="order_id" class="block text-sm font-medium text-slate-700 mb-2">
