    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 relative">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div class="text-center lg:text-left">
                <div
                    class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-100 text-green-600 text-sm font-bold mb-6">
                    <!-- WhatsApp Icon-ish -->
                    <span class="material-symbols-outlined text-base">chat</span>
                    Optimized for WhatsApp
                </div>
                <h1 class="heading-hero text-slate-900 leading-tight mb-6">
                    <span class="text-green-600">WhatsApp</span> Wedding Invitation Videos
                </h1>
...
<section id="templates" class="py-20 bg-white">
    <div class="container-section">
        <div class="text-center mb-12">
            <h2 class="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">Best Sellers for WhatsApp
            </h2>
            <p class="text-slate-600 max-w-2xl mx-auto">Vertical (9:16) designs that fill the phone
...
<section class="py-20 bg-slate-50">
    <div class="container-narrow prose prose-lg">
        ...
        <p>In India and many parts of the world, WhatsApp is the primary mode of communication. Sending a
            <strong>WhatsApp wedding card</strong> is:
        </p>
        <ul>
