    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 relative">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div class="text-center lg:text-left">
                <div
                    class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100 text-blue-600 text-sm font-bold mb-6">
...
<section id="templates" class="py-20 bg-white">
    <div class="container-section">
        <div class="text-center mb-12">
            <h2 class="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">Trending Announcements</h2>
            <p class="text-slate-600 max-w-2xl mx-auto">Short, sweet, and shareable videos to lock
                the date.</p>
        </div>
