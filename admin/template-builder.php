...
<div class="builder-timeline" id="builder-timeline">
    ...
    <div class="timeline-tracks" id="timeline-tracks">
        ...
        <div id="element-tracks" class="element-tracks-container">
            <!-- Each element gets a track row:
            <div class="timeline-track" data-field-id="123">
                <span class="track-label">
                    <span class="track-icon material-symbols-outlined">title</span>
                    Heading Text
                </span>
                <div class="track-bar-container">
                    <div class="track-bar" data-start="0" data-end="3000" style="left: 0%; width: 100%;">
