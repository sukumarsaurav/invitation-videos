                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <select name="remotion_composition_id"
                                ...
                                <?php foreach ($remotionCompositions as $comp): ?>
                                        <option value="<?= Security::escape($comp['id']) ?>"
                                            <?= ($template['remotion_composition_id'] ?? '') === $comp['id'] ? 'selected' : '' ?>
                            ...
                            <p class="text-xs text-slate-500">Select from available Remotion compositions defined in
                                <code class="bg-slate-100 px-1 rounded">config/remotion-compositions.json</code></p>
                        </label>
                    ...
                    <?php elseif (empty($remotionCompositions)): ?>
                            <div class="mt-4 p-3 rounded-lg bg-red-50 border border-red-200 flex items-center gap-2">
                                ...
                                <span class="text-sm text-red-700">No compositions found in <code class="bg-red-100 px-1 rounded">config/remotion-compositions.json</code>. Add compositions to enable the dropdown.</span>
                            </div>
                    <?php else: ?>
